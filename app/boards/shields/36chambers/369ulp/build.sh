...
run "build: 369ulp_left"       west build -d build/369ulp_l       -p -b seeeduino_xiao_ble -- -DSHIELD=369ulp_left
run "build: 369ulp_right"      west build -d build/369ulp_r       -p -b seeeduino_xiao_ble -- -DSHIELD=369ulp_right

echo "=== Building settings_reset firmware ==="
run "build: 369ulp_left_reset"  west build -d build/369ulp_l_reset  -p -b seeeduino_xiao_ble -- -DSHIELD=settings_reset
run "build: 369ulp_right_reset" west build -d build/369ulp_r_reset  -p -b seeeduino_xiao_ble -- -DSHIELD=settings_reset
