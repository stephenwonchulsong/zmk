...
run "build: 369ulp_tp"         west build -d build/369ulp_tp      -p -b xiao_ble//zmk -- -DSHIELD=369ulp_tp
...
run "build: 369ulp_tp_reset"    west build -d build/369ulp_tp_reset -p -b xiao_ble//zmk -- -DSHIELD=settings_reset
...
run "copy: 369ulp_tp.uf2"         cp build/369ulp_tp/zephyr/zmk.uf2       "$OUT_DIR/369ulp_tp.uf2"
...
run "copy: 369ulp_tp_reset.uf2"    cp build/369ulp_tp_reset/zephyr/zmk.uf2 "$OUT_DIR/369ulp_tp_reset.uf2"

echo ""
echo "=== Results ==="
ok=0; fail=0
for label in \
    "build: 369ulp_left" "build: 369ulp_right" "build: 369ulp_tp" \
    "build: 369ulp_left_reset" "build: 369ulp_right_reset" "build: 369ulp_tp_reset" \
    "copy: 369ulp_left.uf2" "copy: 369ulp_right.uf2" "copy: 369ulp_tp.uf2" \
    "copy: 369ulp_left_reset.uf2" "copy: 369ulp_right_reset.uf2" "copy: 369ulp_tp_reset.uf2"
do
